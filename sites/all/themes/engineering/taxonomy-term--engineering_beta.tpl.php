...
<?php if ($term_name == "Bioengineering and Health") :?>
<div id="<?php print strtolower(str_replace(" ", "-", $term_name)); ?>" class="<?php print "impact" ?>">
    ...
    <div class="content">
        ...
        <div class="related-items">
            ...
            <!-- related news -->
            <?php
            if ($content['field_beta_bio_news_view']) : ?>
                <section id="<?php print strtolower(str_replace(" ", "-", $term_name)) . '-related-news'?>" class="related-news">
                    <div class="news-content">
                        <?php $dept_news = field_view_field('taxonomy_term', $term, 'field_beta_bio_news_view', array('label'=>'hidden'));
            ...
            <?php
            if ($content['field_beta_bio_events_view']) : ?>
                <section id="<?php print strtolower(str_replace(" ", "-", $term_name)) . '-related-events'?>" class="related-events">
                    <div class="events-content">
                        <?php $dept_events = field_view_field('taxonomy_term', $term, 'field_beta_bio_events_view', array('label'=>'hidden'));
            ...
            <section id="<?php print strtolower(str_replace(" ", "-", $term_name)) . '-related-faculty'?>" class="related-faculty">
                <div class="faculty-content">
                    <h2>Faculty</h2>
                    <?php
                    $department_faculty = field_view_field('taxonomy_term', $term, 'field_beta_bio_faculty_view', array('label'=>'hidden'));
...
<?php if ($term_name == "Computer Science") :?>
    <div id="<?php print strtolower(str_replace(" ", "-", $term_name)); ?>" class="<?php print "impact" ?>">
        ...
        <div class="content">
            ...
            <div class="related-items">
                ...
                <!-- related news -->
                <?php
                if ($content['field_beta_compsci_news_view']) : ?>
                    <section id="<?php print strtolower(str_replace(" ", "-", $term_name)) . '-related-news'?>" class="related-news">
                        <div class="news-content">
                            <?php $dept_news = field_view_field('taxonomy_term', $term, 'field_beta_compsci_news_view', array('label'=>'hidden'));
                            print '<h2>' . render($term_name) . ' News</h2>';
                            print render($dept_news);
                            ?>
                        </div>
                ...
                <?php
                if ($content['field_compsci_events_view']) : ?>
                    <section id="<?php print strtolower(str_replace(" ", "-", $term_name)) . '-related-events'?>" class="related-events">
                        <div class="events-content">
                            <?php $dept_events = field_view_field('taxonomy_term', $term, 'field_beta_compsci_events_view', array('label'=>'hidden'));
                            print '<h2>' . render($term_name) . ' Events</h2>';
                            print render($dept_events);
                            ?>
                        </div>
                ...
                <section id="<?php print strtolower(str_replace(" ", "-", $term_name)) . '-related-impact'?>" class="related-impact">
                    <div class="impact-content">
                        ...
                        <?php
                        $department_impact = field_view_field('taxonomy_term', $term, 'field_beta_cs_impact_view', array('label'=>'hidden'));
                ...
                <section id="<?php print strtolower(str_replace(" ", "-", $term_name)) . '-related-faculty'?>" class="related-faculty">
                    <div class="faculty-content">
                        <h2>Faculty</h2>
                        <?php
                        $department_faculty = field_view_field('taxonomy_term', $term, 'field_beta_cs_faculty_view', array('label'=>'hidden'));
                        //Compact creates arrays containing variables and their values
                        $department_associated_faculty = compact("department_faculty", "department_related_faculty");
                        print render($department_associated_faculty)
                        ?>
